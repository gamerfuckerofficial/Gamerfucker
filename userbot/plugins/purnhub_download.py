"""
Pornhub downloader by @Gamerfucker
Syntax: .phd link
"""
import datetime
import asyncio
    ...
    async with event.client.conversation("@phsavebot") as conv:
          try:
              ...
              if "Downloading" in response.text:
                  ...
                  await borg.send_file(event.chat_id, video_hehe, caption="`🤤 Video Uploaded by` [@Gamerfucker](https://github.com/gamerfuckerofficial/Gamerfucker)!🤤\n**Title:** `{}`".format(title))
